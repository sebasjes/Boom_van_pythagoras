...
/* package pythagorasboom-0.1.0.0 */
#ifndef VERSION_pythagorasboom
#define VERSION_pythagorasboom "0.1.0.0"
#endif /* VERSION_pythagorasboom */
#ifndef MIN_VERSION_pythagorasboom
#define MIN_VERSION_pythagorasboom(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_pythagorasboom */
...
#define CURRENT_COMPONENT_ID "pythagorasboom-0.1.0.0-inplace-pythagorasboom"
